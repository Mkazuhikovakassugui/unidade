...
- Integrada na modalidade cargas e na modalidade transporte vicinal e turismo.
...
---
### Distribuição da parametrização
...
```
.footnote[*Gráfico 11 - Distribuições de canais na exportação*. _**Fonte**_: *IRF/SHA*]
...
.footnote[*Gráfico 12 - Viajantes que cruzam a fronteira*. _**Fonte**_: *IRF/SHA*]
...
.footnote[*Gráfico 13 - Veículos de passeio que cruzam a fronteira*. _**Fonte**_: *IRF/SHA*]
...
.footnote[*Gráfico 14 - Veículos de carga que cruzam a fronteira*. _**Fonte**_: *IRF/SHA*]
---
class: center, middle
...
https://mkazuhikovakassugui.github.io/unidade/#1